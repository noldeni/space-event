#selection-insertion-sort-tutorial-sonicpi.rb
#https://gist.github.com/MynahMarie/ce76edb51cce7be2686dc4853289837b#file-selection-insertion-sort-tutorial-sonicpi-rb
#https://www.earthtoabigail.com/blog/audio-representation-selection-and-insertion-sort-ruby-sonicpi
# SELECTION and INSERTION Sort - Audio Representation with Sonic Pi
# Earth To Abigail
  ...
  for i in 0..r
    ...
    in_thread do
      if min_idx != i
        ...
        swaps += 1
        use_synth :tb303
        play arr[min_idx], amp: 0.4, sustain: 0.1, decay: 0.2, release: 0.1, cutoff: 60 # Play the note that was swapped with arr[i]
      else
        # Marks that no swap was needed
        sample :drum_snare_soft, amp: 2, rate: -1
      end
    end
    
    # Play the selected note
    use_synth :tb303
    play arr[i], cutoff: 70, sustain: 0.1, decay: 0.2, release: 0.1, amp: 0.5
